...
import io.vertx.starter.kafka.EventsVerticle;
import io.vertx.starter.persistence.ApiVerticle;
...
public class Main {
	...
	private static Single<String> run(Class<? extends AbstractVerticle> verticle, VertxOptions options,
		...
		return vertx
				...
				.flatMap(id-> vertx.rxDeployVerticle(verticle.getName(), deploymentOptions))
